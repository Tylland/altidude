...
namespace Altidude.net.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var user = views.Users.GetById(new Guid(userId));
        ...
        //
        // POST: /Manage/UpdateSettings
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult UpdateSettings(UserSettingsViewModel model)
        {
            var application = ApplicationManager.BuildApplication();

            application.ExecuteCommand(new UpdateUserSettings(model.UserId, model.FirstName, model.LastName, model.AcceptsEmails));
