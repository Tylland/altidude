...
(function (ProfileChart) {
    ...
    var AltitudeAxis = (function (_super) {
        ...
        function AltitudeAxis(minAltitude, maxAltitude) {
            var padding = this.getPadding(maxAltitude - minAltitude);
        ...
        AltitudeAxis.prototype.calcMin = function (minAltitude, maxAltitude, gridMinor, gridMajor) {
            var roundFactor = gridMajor;
            var minBase = Math.min(minAltitude, 0);
            return Math.max(Math.floor(minAltitude / roundFactor) * roundFactor, minBase);
        };
        AltitudeAxis.prototype.calcMax = function (minAltitude, maxAltitude, gridMinor, gridMajor) {
            var roundFactor = gridMajor;
